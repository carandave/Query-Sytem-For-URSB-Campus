...
$sql = $conn->query("SELECT * FROM tbl_faqs WHERE department='Guidance'");
...
<div class="wrapper">
<div class="title">GUIDANCE OFFICE</div>
<div class="form">
...
<!-- <a href="live_guidance.php" class="btn btn-primary">Live Chat</a> -->
