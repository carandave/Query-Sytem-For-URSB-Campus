...
<header id="" class="header" style="z-index: 100;">                          
...
<span class="logo-title ml-3" style="font-size: 18px;">REGISTRAR OFFICE </span>
</a>
...
<li class="nav-item"><a class="nav-link" href="charterRegistrar.php">Citizen's Charter</a></li>
<li class="nav-item"><a class="nav-link" href="settings_Registrar.php">Settings</a></li>
...
<div class="container">
<h2 class="title text-center">"Organizational Chart Registrar Office"</h2>
        ...
        <div class="col-md-12 d-flex justify-content-end flex-column">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Registrar Member</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="adminREGISTRAR_add.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="announcementModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Registrar Announcement</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
<section id="features" class="about section">
    ...
    <div class="container text-center">
        ...
        <h2 class="title">"Announcements and Latest News About the Registrar's Office"</h2>
