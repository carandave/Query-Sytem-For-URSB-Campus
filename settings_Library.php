...
<section id="docs" class="docs section">
        <div class="container">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="adminLIBRARY_ANNOUNCEMENT_add.php" method="POST" enctype="multipart/form-data">
                            <input type="text" name="office" id="office" value="<?php echo $office?>" class="form-control"  required>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="adminLIBRARY_FAQS_add.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
