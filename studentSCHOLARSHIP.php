...
<span class="logo-title">SCHOLARSHIP AND FINANCE ASSISTANCE</span>
</a>
...
<li class="nav-item"><a class="nav-link" href="chat_scholarship.php">CHATBOT</a></li>
<li class="nav-item"><a class="nav-link" href="chatbox.php?toId=1005">LIVE CHAT</a></li>
...
<?php 
        ...
        $result = $conn->query("SELECT * FROM orgchart WHERE department='Scholarship'");
...
<div class="content">
<h3 class="sub-title">Gives opportunity to Students to get Scholarship and financial support for their education.</h3>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">Help Students to have financial support in College Education.</h3>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">Coordinate with the Campus Director in the implementation of different subject related programs.</h3>
</div>
</div>            
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">A scholarship that can also help Students family problems.</h3>
<p></p>
</div>
</div>               
<div class="item col-lg-4 col-md-6 col-12">
...
<div class="content">
<h3 class="sub-title">Initiate and recommend of maintaining grades every semester in the whole 4 years in College Education.</h3>
<p></p>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
...
<div class="container text-center">
    ...
    <h2 class="title">"ANNOUNCEMENTS / LATEST NEWS ABOUT SCHOLARSHIP OFFICE"</h2>
...
<form method="post" action="send_scholarship.php">
<div class="my-4">
