...
<span class="logo-title">HEALTH OFFICE</span>
</a>
...
<li class="nav-item"><a class="nav-link" href="chat_clinic.php">CHAT BOT</a></li>
<li class="nav-item"><a class="nav-link" href="settings_Clinic.php">SETTINGS</a></li>
<li class="nav-item"><a class="nav-link" href="chatReport.php">REPORTS</a></li>
<li class="nav-item"><a class="nav-link" href="charterClinic.php">CITIZEN'S CHARTER</a></li>
...
<div class="container">
<h2 class="title text-center">"Organizational Chart Health Office"</h2>
        ...
        <div class="col-md-12 d-flex justify-content-end flex-column">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Clinic Member</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="adminCLINIC_add.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="announcementModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Clinic Announcement</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <form action="adminCLINIC_ANNOUNCEMENT_add.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
...
<div class="container text-center">
    ...
    <h2 class="title">"Announcements and Latest News About the Health Office"</h2>
