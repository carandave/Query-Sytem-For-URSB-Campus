...
$sql = $conn->query("SELECT * FROM tbl_faqs WHERE department='Scholarship and Finance Assistance'");
...
<div class="wrapper">
<div class="title">SCHOLARSHIP AND FINANCE ASSISTANCE OFFICE</div>
<div class="form">
...
<!-- <a href="live_scholarship.php" class="btn btn-primary">Live Chat</a> -->
