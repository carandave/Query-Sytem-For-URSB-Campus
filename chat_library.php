...
$sql = $conn->query("SELECT * FROM tbl_faqs WHERE department='Library'");
...
<div class="wrapper">
<div class="title">LIBRARY OFFICE</div>
<div class="form">
...
<!-- <a href="live_library.php" class="btn btn-primary">Live Chat</a> -->
