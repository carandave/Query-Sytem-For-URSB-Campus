...
<li class="nav-item"><a class="nav-link" href="chat_admission.php">CHAT BOT</a></li>  
<li class="nav-item"><a class="nav-link " href="settings_Admission.php">SETTINGS</a></li>    
<li class="nav-item"><a class="nav-link" href="chatReport.php">REPORTS</a></li>
<li class="nav-item"><a class="nav-link" href="charterAdmission.php">CITIZEN'S CHARTER</a></li>
...
<div class="container">
<h2 class="title text-center">"Organizational Chart Admission Office"</h2>
        ...
        <div class="col-md-12 d-flex justify-content-end flex-column">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Admission Member</h5>
...
<div class="modal fade" id="announcementModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Admission Announcement</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <form action="adminADMISSION_ANNOUNCEMENT_add.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
...
<div class="container text-center">
    ...
    <h2 class="title">"Announcements and Latest News About the Admission Office"</h2>
