...
<li class="nav-item"><a class="nav-link" href="chat_ojt.php">CHAT BOT</a></li>  
<li class="nav-item"><a class="nav-link " href="settings_Ojt.php">SETTINGS</a></li> 
...
<div class="container">
<h2 class="title text-center">"Organizational Chart OJT and Placement Office"</h2>
...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-12 d-flex justify-content-end flex-column">
            ...
            Add OJT and Placement Office Member
            </button>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add OJT and Placement Office Member</h5>
...
<div class="modal fade" id="announcementModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    ...
                    <form action="adminOJT_ANNOUNCEMENT_add.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
...
<div class="container text-center">
    ...
    <!-- <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#announcementModal">
        Add OJT and Placement Announcement
    </button> -->

    <?php 

    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='OJT and Placement' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News About the OJT and Placement Office"</h2>
