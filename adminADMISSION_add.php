            ...
            for($i = 0; $i<count($file_array); $i++){
                if($file_array[$i]['error']){
                    ...
                    if(!in_array($file_ext, $extensions)){
                        ...
                        echo '<script>alert("Successfully Uploaded OSDS Office Organizational Chart Member")</script>';
                        echo '<script>window.location.href = "adminADMISSION.php"</script>';
                    }
