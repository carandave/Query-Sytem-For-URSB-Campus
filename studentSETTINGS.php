...
<span class="logo-title">Student Settings</span>
</a>
            ...
            <form action="" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?php echo $rows['f_name'];?>" class="form-control">
                    </div>

                    <div class="col-md-6">
                        <label for="">Last Name</label>
                        <input type="text" value="<?php echo $rows['l_name'];?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?php echo $rows['m_name'];?>" class="form-control">
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?php echo $rows['user_name'];?>" class="form-control">
                    </div>
