...
$sql = $conn->query("SELECT * FROM tbl_faqs WHERE department='Admission'");
...
<div class="wrapper">
<div class="title">ADMISSION OFFICE</div>
<div class="form">
...
<!-- <a href="live_admission.php" class="btn btn-primary">Live Chat</a> -->
<button id="send-btn" class="btn btn-primary">Send</button>
<a class="btn btn-primary" href="index.php">Back</a>
<button onclick="togglePopup()" class="btn btn-secondary">Exit Chat</button>
</div>
</div>
<script>
...
<br>
<br>
<h3>Already got answers to your concerns?</h3>
<br>
<p>Please consider taking a little time to answer our feedback form that will help us improve the system.</p>
<br>
<p>Thank you, students, and God bless.</p>
<br>
<br>
<h5><a href="https://docs.google.com/forms/d/e/1FAIpQLSeoL9c00mU2mTtdiGbaP-A9H5t1f_QgWrIDCM_hTWa_kQ3qnw/viewform?usp=share_link" target="_blank">CLICK HERE.</a></h5>
</div>
</div>
