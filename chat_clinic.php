...
$sql = $conn->query("SELECT * FROM tbl_faqs WHERE department='Clinic'");
...
<div class="wrapper">
<div class="title">HEALTH OFFICE</div>
<div class="form">
...
<!-- <a href="live_clinic.php" class="btn btn-primary">Live Chat</a> -->
