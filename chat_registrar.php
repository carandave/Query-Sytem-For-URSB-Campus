...
$sql = $conn->query("SELECT * FROM tbl_faqs WHERE department='Registrar'");
...
<div class="wrapper">
<div class="title">REGISTRAR OFFICE</div>
<div class="form">
...
<!-- <a href="live_registrar.php"  class="btn btn-primary">Live Chat</a> -->
</div>
</div>
<br>
