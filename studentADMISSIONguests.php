...
<span class="logo-title">ADMISSION OFFICE</span>
</a>
...
<li class="nav-item"><a class="nav-link" href="chat_admission.php">CHATBOT</a></li>             
...
<div class="container">
<a href="index.php" class="btn">Back to Landing Page</a>
<h2 class="title text-center">"Organizational Chart"</h2>
<?php 
    
        $result = $conn->query("SELECT * FROM orgchart WHERE department='Admission'");
...
<div class="content">
<h3 class="sub-title">Admission Office is the one giving enrollments announcements for upcoming school year.</h3>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">Office of the Student Development and Services stands to be a foundation to many offices inside the University.</h3>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">Released announcement of qualified Students in different courses in the University.</h3>
</div>
</div>            
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">In charge in production of ID in the University.</h3>
<p></p>
</div>
</div>               
<div class="item col-lg-4 col-md-6 col-12">
...
<div class="content">
<h3 class="sub-title">Handle the inquiries and concerns regarding upcoming school year of the University.</h3>
<p></p>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
...
<div class="container text-center">
    ...
    <h2 class="title">"Announcements / Latest News about Admission Office"</h2>
...
<p class="intro  text-center">I hope you can find Web-Based Query System for University of Rizal System useful for all of your queries and concerns.<br />Feel free to get in touch with the offices admins if you have any questions or suggestions.</p>
