...
<span class="logo-title">Announcements</span>
</a>
...
<section id="about" class="about section">
    ...
    <div class="container text-center">
        ...
        $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Registrar' ORDER BY announcementId DESC");

        ?>

        <h2 class="title">"Announcements and Latest News about Registrar Office"</h2>
            ...
            <?php while($dataa = $resulta->fetch_assoc()){ ?>
                <div class="col-md-4 d-flex justify-content-center align-items-center">
                        <div class="card text-white bg-info mb-3" style="min-height: 400px; max-width: 18rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-dark" style=""><?php echo $dataa['date_created']?></h5>
...
<div class="container text-center">
    ...
    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Clinic' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News about Health Office"</h2>
...
<div class="container text-center">
    ...
    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Librarian' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News about Library Office"</h2>
...
<div class="container text-center">
    ...
    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Admission' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News about Admission Office"</h2>
...
<div class="container text-center">
    ...
    <h2 class="title">"Announcements and Latest News about Guidance Office"</h2>
...
<div class="container text-center">
    ...
    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Ojt' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News about OJT and Placement Office"</h2>
...
<div class="container text-center">
    ...
    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Scholarship' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News about Scholarship and Finance Assistance Office"</h2>
