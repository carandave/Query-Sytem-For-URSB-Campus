...
<span class="logo-title">OJT AND PLACEMENT</span>
</a>
...
<li class="nav-item"><a class="nav-link" href="chat_ojt.php">CHATBOT</a></li>
<li class="nav-item"><a class="nav-link" href="chatbox.php?toId=1006">LIVE CHAT</a></li>
...
<?php 
        ...
        $result = $conn->query("SELECT * FROM orgchart WHERE department='Ojt'");
...
<div class="content">
<h3 class="sub-title">Gives opportunity to Students to complete their OJT inside the University.</h3>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">Providing and implementing on the job training for Students.</h3>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">Coordinate with the Campus Director in the implementation of Students distribution in different Offices.</h3>
</div>
</div>            
<div class="item col-lg-4 col-md-6 col-12">
<div class="icon-holder">
...
<div class="content">
<h3 class="sub-title">Providing tasks and activities related to real works.</h3>
<p></p>
</div>
</div>               
<div class="item col-lg-4 col-md-6 col-12">
...
<div class="content">
<h3 class="sub-title">Initiate and recommend different work and subjects related programs for the University.</h3>
<p></p>
</div>
</div>
<div class="item col-lg-4 col-md-6 col-12">
...
<div class="container text-center">
    ...
    <h2 class="title">"ANNOUNCEMENTS / LATEST NEWS ABOUT OJT and Placement OFFICE"</h2>
...
<form method="post" action="send_ojt.php">
<div class="my-4">
