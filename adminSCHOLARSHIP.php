...
<li class="nav-item"><a class="nav-link" href="chat_scholarship.php">CHAT BOT</a></li>  
<li class="nav-item"><a class="nav-link " href="settings_Scholarship.php">SETTINGS</a></li>   
...
<div class="container">
<h2 class="title text-center">"Organizational Chart Scholarship and Finance Assistance Office"</h2>
...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-12 d-flex justify-content-end flex-column">
            ...
            Add Scholarship and Finance Assistance Office Member
            </button>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Scholarship and Finance Assistance Office Member</h5>
...
<div class="modal fade" id="announcementModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Scholarship Announcement</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <form action="adminSCHOLARSHIP_ANNOUNCEMENT_add.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
...
<div class="container text-center">
    ...
    <!-- <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#announcementModal">
        Add Scholarship Announcement
    </button> -->

    <?php 

    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Scholarship and Finance Assistance' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News About the Scholarship and Finance Assistance Office"</h2>
