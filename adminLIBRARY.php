...
<span class="logo-title">LIBRARY OFFICE</span>
</a>
...
<li class="nav-item"><a class="nav-link" href="chat_library.php">CHAT BOT</a></li>  
<li class="nav-item"><a class="nav-link " href="settings_Library.php">SETTINGS</a></li> 
<li class="nav-item"><a class="nav-link" href="chatReport.php">REPORTS</a></li>
<li class="nav-item"><a class="nav-link" href="charterLibrary.php">CITIZEN'S CHARTER</a></li>
...
<section id="about" class="about section">
    <div class="container">
    <h2 class="title text-center">"Organizational Chart Library Office"</h2>
        ...
        <div class="col-md-12 d-flex justify-content-end flex-column">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Librarian Member</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="adminLIBRARY_add.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="announcementModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Library Announcement</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <form action="adminLIBRARY_ANNOUNCEMENT_add.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
...
<div class="container text-center">
    ...
    <!-- <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#announcementModal">
        Add Library Announcement
    </button> -->

    <?php 

    $resulta = $conn->query("SELECT * FROM tbl_announcement WHERE department='Library' ORDER BY announcementId DESC");

    ?>

    <h2 class="title">"Announcements and Latest News About the Library Office"</h2>
