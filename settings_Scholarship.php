...
<div class="btns">
<a class="btn btn-cta-primary" href="adminSCHOLARSHIP.php">Back to Home Page</a>
</div>
...
<section id="docs" class="docs section">
        <div class="container">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="adminSCHOLARSHIP_FAQS_add.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
